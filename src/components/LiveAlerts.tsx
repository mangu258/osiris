    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="hud-text text-[10px] text-[var(--text-primary)]">实时警报</span>
          ...
          <span className="gotham-tag gotham-tag--info" style={{ fontSize: '7px', padding: '1px 4px' }}>{BUILTIN_FEEDS.length} 直播</span>
        </div>
        <div className="flex items-center gap-2">
